...
for i in range(501, 531):
    ...
    text_images = [
        ...
        os.path.join(base_dir, "sentences1", f"{random.randint(0, 99)}.png"),  # 금액아래 글자1
        os.path.join(base_dir, "sentences2", f"{random.randint(0, 99)}.png"),  # 금액아래 글자2
        os.path.join(base_dir, "sentences1", f"{random.randint(0, 99)}.png"),  # micr코드 위 글자
    ...
    positions_ratio = [
        ...
        (0.23, 0.40, 0.35, 0.035),  # 금액아래 글자1
        (0.23, 0.45, 0.15, 0.035),  # 금액아래 글자2
        (0.28, 0.77, 0.35, 0.035),  # micr코드 위 글자
    ...
    amount_img_path = os.path.join(base_dir, "amount", f"{random.randint(0, 9)}.png")  # 금액
    ...
    amount_kor_img_path = os.path.join(base_dir, "amountKo", f"{random.randint(0, 9)}.png")  # 금액
    ...
    bank_target_height = int(bg_height * 0.04)
    bank_img_path = os.path.join(base_dir, "short_bank_names", f"{random.randint(0, 9)}.png")  # 금액
    ...
    transcription = ["지급지 상단", "지급지 하단", "주식회사 상단", "주식회사 하단", "상단 은행명", "하단 은행명",
                     "금액아래 글자1", "금액아래 글자2", "micr코드 위 글자", "원 기호", "앞", "시리얼번호", "년",
                     "월", "일", "자기앞수표 제목", "micr글자 2개", "micr글자 3개",
                     "micr글자 9개", "박스내부 글자 1", "박스내부 글자 2", "지역 ", "은행",
                     "직급 글자1", "직급 글자2", "직급 글자3", "성명", "금액", "금액 한글"]
